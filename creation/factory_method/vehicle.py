...
class VehicleFactory(ABC):
    ...
    @staticmethod
    @abstractmethod
    def getVehicle(type_vehicle: str) -> Vehicle: pass
...
if __name__ == '__main__':
    ...
    south_zone_available_vehicles = ['lux', 'pop',]

    print('North Zone')
    for i in range(10):
        # north zone
        north_vehicle = NorthZoneVehicleFactory(
            choice(north_zone_available_vehicles))
    ...
    for i in range(10):
        # south zone
        south_vehicle = SouthZoneVehicleFactory(
            choice(south_zone_available_vehicles))
