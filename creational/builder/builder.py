...
class IUserBuilder(ABC):
    ...
    @abstractmethod
    def addFirstname(self, firstname): pass

    @abstractmethod
    def addLastname(self, lastname): pass

    @abstractmethod
    def addAge(self, age): pass

    @abstractmethod
    def addPhone(self, phone): pass

    @abstractmethod
    def addAddress(self, address): pass
...
class UserDirector:
    ...
    def withAge(self, firstname, lastname, age):
        self._builder.addFirstname(firstname).addLastname(
            lastname).addAge(age)
